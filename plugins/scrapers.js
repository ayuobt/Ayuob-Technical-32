...
Asena.addCommand({pattern: 'song ?(.*)', fromMe: true, desc: Lang.SONG_DESC}, (async (message, match) => { 
    ...
    Asena.applyCMD({ pattern: 'apk ?(.*)', fromMe: LOL, desc: Lang.APK_DESC,  deleteCommand: false}, async (message, match) => {
    ...
    var apk = await WhatsAsena.apk(link)
    var apkinfo = await WhatsAsena.apk_info(link)
