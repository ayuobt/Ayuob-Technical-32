...
const need = "Writes Your text on leaves\n🙄🙄🙄"
...
if (Config.WORKTYPE == 'private') {
  ...
  Asena.addCommand({ pattern: 'leavest ?(.*)', fromMe: true, dontAddCommandList: true }, (async (message, match) => {
    ...
    await message.sendMessage(Buffer.from(ttinullimage.data), MessageType.image, { mimetype: Mimetype.jpg, caption: '*Made by Baala*' })
